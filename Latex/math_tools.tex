...
\begin{figure}
	...
	\begin{tikzpicture}[tdplot_main_coords]
		...
		\draw[-latex, line width=1pt, shorten <= 0.1cm, shorten >= 0.1cm] (Fe) to[in=-60, out=20, distance=1.2cm] node[pos=0.5, anchor=west]{$g_a$} (P1);
		\draw[-latex, line width=1pt, shorten <= 0.1cm, shorten >= 0.1cm] (Fe) to[in=-90, out=180, distance=1.2cm] node[pos=0.5, anchor=west]{$g_b$} (P2);
